    ...
    <div>
        <Form>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" placeholder='Insira o nome do filme' onChange={handleEventName} value={name}/>
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>
                  Descrição: 
              </Form.Label>
              <Form.Control type="text" placeholder='Insira o descrição' onChange={handleEventDescricao} value={descricao}/>
            </Form.Group>
        </Form >
        <div className="text-center">
        <Button onClick={() => store(dados)}><FaCheck /> Salvar</Button>{' '}
